...
namespace HotelReservationsManager.Migrations
{
    ...
    [Migration("20250408202514_InitialCreate")]
            ...
            modelBuilder.Entity("ClientReservation", b =>
                {
                    ...
                    b.HasKey("ClientsId", "ReservationId");
            ...
            modelBuilder.Entity("HotelReservationsManager.Models.Room", b =>
                {
                    ...
                    b.Property<decimal>("AdultPricePerBed")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("Capacity")
                        .HasColumnType("int");

                    b.Property<decimal>("ChildPricePerBed")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HotelReservationsManager.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("HotelReservationsManager.Models.ApplicationUser", "User")
                        .WithMany()
